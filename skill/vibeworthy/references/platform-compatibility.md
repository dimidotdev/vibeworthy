...
6. Test one harmless prompt for invocation and one prompt that should trigger `critical` behavior. Record unsupported references, scripts, or automatic behavior explicitly.
